...
public class MyStepdefs {
    ...
    public void user_select_customer_service() throws Throwable {
        // Write code here that turns the phrase above into concrete actions
        throw new PendingException();
    }
    ...
    public void user_enter_text_message() throws Throwable {
        // Write code here that turns the phrase above into concrete actions
        throw new PendingException();
    }
    ...
    public void user_can_see_message_has_been_successfully_sent() throws Throwable {
        // Write code here that turns the phrase above into concrete actions
        throw new PendingException();
    }

    @When("^user click on singIn button$")
    public void user_click_on_singIn_button() throws Throwable {
        // Write code here that turns the phrase above into concrete actions
        throw new PendingException();
    }

    @When("^user enter  already register email id$")
    public void user_enter_already_register_email_id() throws Throwable {
        // Write code here that turns the phrase above into concrete actions
        throw new PendingException();
    }

    @When("^user click on creat an account button$")
    public void user_click_on_creat_an_account_button() throws Throwable {
        // Write code here that turns the phrase above into concrete actions
        throw new PendingException();
    }

    @Then("^user can see the error messaage$")
    public void user_can_see_the_error_messaage() throws Throwable {
        // Write code here that turns the phrase above into concrete actions
        throw new PendingException();
    }
